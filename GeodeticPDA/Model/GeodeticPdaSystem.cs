...
namespace GeodeticPDA.Model
{
    class GeodeticPdaSystem : IDisposable
    {
        ...
        private const int BlockByteSize = 256; // (Property.ByteSize = 84) * 3 + (ValidItemsCount = 4) = 252 + (4) = 256
        private const int OverfillingBlockByteSize = 256; // 252 * 2 + (ValidItemsCount = 4) = 256
